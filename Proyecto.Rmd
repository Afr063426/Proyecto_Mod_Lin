...
data<-cbind(data,"NivelDeContaminacion"=cut(data$PM2.5, breaks = c(seq(0, 1000,100)), include.lowest  = T))
```
...
ggcorrplot(cor(data%>%select(-c(Fecha, hour,wd,station,NivelDeContaminacion )), use = "complete.obs"))
